    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="../blog/index.php" class="nav-link <?php echo isActive('blog') ?>">
                        <i class="nav-icon fas fa-newspaper"></i>
                        <p> บทความ </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="../contact/index.php" class="nav-link <?php echo isActive('contact') ?>">
                        <i class="nav-icon fas fa-address-book"></i>
                        <p> การติดต่อ </p>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="../log/index.php" class="nav-link <?php echo isActive('log') ?>">
